...
def test_database_metadata_contains_core_tables():
    ...
    assert KnowledgeSegmentModel.__tablename__ in Base.metadata.tables
    assert KnowledgeProcessingJobModel.__tablename__ in Base.metadata.tables
    ...
    assert "knowledge_segments" in Base.metadata.tables
    assert "knowledge_processing_jobs" in Base.metadata.tables
