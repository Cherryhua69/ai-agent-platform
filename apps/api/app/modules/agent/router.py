...
run_service = AgentRunService(traces=TraceRepository(session_factory=SessionLocal))
...
def simulate_agent_run(agent_id: str) -> RunTraceRead:
    return run_service.simulate_run(agent_id)
